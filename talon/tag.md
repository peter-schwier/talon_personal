...
Talon tags cannot be set via python.  Talon tags can only be set via talon files.
...
Seems the best way to handle this is to have a [[mode]] set a [[tag]], and then the [[tag]]s define [[talon/action]]s.